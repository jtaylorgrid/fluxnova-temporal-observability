...
func (a *Activities) AnalyzeSentiment(ctx context.Context, processInstanceID string, input TicketInput) (*SentimentResult, error) {
...
func (a *Activities) LookupCustomerProfile(ctx context.Context, processInstanceID string, customerID string) (*CustomerProfile, error) {
...
func (a *Activities) CheckChurnSignals(ctx context.Context, processInstanceID string, customerID string) (*ChurnSignals, error) {
...
func (a *Activities) DecideRouting(ctx context.Context, processInstanceID string, input struct {
	Ticket    TicketInput
...
func (a *Activities) GenerateResponse(ctx context.Context, processInstanceID string, input struct {
	Ticket    TicketInput
	Sentiment SentimentResult
	Profile   CustomerProfile
